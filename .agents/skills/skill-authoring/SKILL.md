...
1. **`AGENTS.md`** — always loaded. Commands, recorded decisions with re-add triggers, cross-cutting gotchas, non-inferable domain facts. Nothing that also lives in a skill.
