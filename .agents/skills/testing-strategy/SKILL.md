...
**Architectural Rule Enforcement** with [Best.Conventional](https://github.com/andrewabest/Conventional) (`Conventions/` directory: `ApiConventionTests`, `CachingConventionTests`, `CqrsConventionTests`, `DapperConventionTests`, `DomainConventionTests`, `NamingConventionTests`, `PersistenceConventionTests`).
