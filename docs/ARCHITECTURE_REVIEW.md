...
**Score: 9.5/10** (81 findings resolved; 3 open findings from the 2026-06-07 review — one medium, two low — plus one reclassified as an accepted limitation)
...
Still open after this session: **#76** (medium — money rounding) and **#78, #79** (low). **#74, #75, #77, #81** are resolved — see the table immediately below. **#80** was investigated and reclassified as an **accepted limitation** (EF cannot express the index; see the limitation note below the open table).
