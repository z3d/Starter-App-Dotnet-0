export const meta = {
  ...
  description: 'Review the current branch diff with this repo\'s backend architect and security auditor in parallel (rule-adherence per AGENTS.md + bug/security hunt), then adversarially verify each finding line-by-line. Returns findings tagged real/noise for the main agent\'s final triage against docs/ARCHITECTURE_REVIEW.md.',
  phases: [
    { title: 'Review' },
    { title: 'Verify' },
  ],
...
const LENSES = {
  backend: { agentType: 'backend-architect', what: 'the .NET backend under src/ — AGENTS.md rule adherence (CQRS separation, DDD, owner-scope, outbox, concurrency) and real bugs' },
