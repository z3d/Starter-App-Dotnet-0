...
6. Mirror equivalent guidance changes into `.agents/skills/**` and `AGENTS.md`; keep only intentional agent-specific path/name drift (`AgentDocsConventionTests` fails the build on any other drift)
